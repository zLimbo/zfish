...
static void calculateDelaunayTriangles(Rect rect, vector<Point2f> &points,
...
void warpTriangle(Mat &img1, Mat &img2, vector<Point2f> &t1,
                  vector<Point2f> &t2) {
...
int main(int argc, char **argv) {
    ...
    {  // my convex hull
        ...
        zLimbo::myConvexHull2(points2, hullIndex3);

        sort(hullIndex.begin(), hullIndex.end());
        sort(hullIndex2.begin(), hullIndex2.end());
        sort(hullIndex3.begin(), hullIndex3.end());
        ...
        cout << endl;
        cout << "myConvexHull:\t";
        for (int k : hullIndex2)
            cout << k << " ";
        cout << endl;
        cout << "myConvexHull2:\t";
        for (int k : hullIndex3)
            cout << k << " ";
        cout << endl;
    }
...
////	sort(hullIndex3.begin(), hullIndex3.end());
//
//	for (int k : hullIndex) cout << k << " "; cout << endl;
//	for (int k : hullIndex2) cout << k << " "; cout << endl;
//	for (int k : hullIndex3) cout << k << " "; cout << endl;
//
//}
//
// int main() {
